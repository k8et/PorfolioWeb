...
const Contact = () => {
    ...
    return (
        <div id='#contact'
             className=' flex flex-col items-center pt-24 h-full justify-center bg-tahiti-100 gap-20 pb-20 md:h-screen md:pt-0 '>
                ...
                <div className="flex flex-col items-center gap-5 z-10">
                    ...
                    {contactMethods.map((method, index) => (
                        ...
                        >
                            ...
                            <a href={method.link} className="inline-flex items-center text-sm" target="_blank" rel="noreferrer">
                                Write me
                                <i className="bx bx-right-arrow-alt  text-sm ml-1 transition-transform duration-300 transform"></i>
                            </a>
                        </div>
                    ))}
                </div>
