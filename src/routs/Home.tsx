...
const Home: FC<HomeProps> = props => {
    ...
    return (
        <div
            id="#home"
            className="flex flex-col items-center w-full h-screen justify-center bg-tahiti-100 p-20 md:p-0 md:h-screen z-10"
        >
            <HomeImage>
                <div
                    className="flex flex-col-reverse mr-0 items-center xl:flex-row w-full xl:mr-28 xl:w-8/12 gap-5 xl:gap-20">
                    ...
                    <div className="flex items-center flex-col justify-center gap-5">
                        ...
                        <p className="text-sm xl:text-base text-tahiti-200 animate-fade-in">
                            A results-driven, enthusiastic, creative Web Developer with excellent communication
                            skills,
